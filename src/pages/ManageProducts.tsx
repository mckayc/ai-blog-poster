                ...
                <div className="flex gap-4 items-start flex-grow">
                    ...
                    <div className="flex-grow">
                        <div className="flex items-start gap-2">
                           <h3 className="text-lg font-bold text-white line-clamp-2 flex-grow">{product.name}</h3>
                           {product.productUrl && (
                                <a href={product.productUrl} target="_blank" rel="noopener noreferrer" title="View source URL" className="text-slate-400 hover:text-indigo-400 flex-shrink-0">
                        ...
                        {product.price && <p className="text-md font-semibold text-emerald-400 mt-1">{formatPrice(product.price)}</p>}
                    </div>
                </div>
